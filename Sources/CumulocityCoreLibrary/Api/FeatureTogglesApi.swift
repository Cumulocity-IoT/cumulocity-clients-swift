...
public class FeatureTogglesApi: AdaptableApi {
	...
	public func getCurrentTenantFeature(featureKey: String) -> AnyPublisher<C8yFeatureToggle, Error> {
		let builder = URLRequestBuilder()
	...
	///   - featureKey:
	///     A unique key of the feature toggle.
	public func listTenantFeatureToggleValues(featureKey: String) -> AnyPublisher<[C8yTenantFeatureToggleValue], Error> {
		let builder = URLRequestBuilder()
	...
	///   - featureKey:
	///     A unique key of the feature toggle.
	public func setCurrentTenantFeatureToggleValue(body: C8yFeatureToggleValue, featureKey: String) -> AnyPublisher<Data, Error> {
	...
	///   - featureKey:
	///     A unique key of the feature toggle.
	public func unsetCurrentTenantFeatureToggleValue(featureKey: String) -> AnyPublisher<Data, Error> {
		let builder = URLRequestBuilder()
			.set(resourcePath: "/features/\(featureKey)/by-tenant")
